...
pub(super) static LIST_LANGS: &str = r#"English language name                         | Triple code    | Duo code       | Alt triple code
----------------------------------------------+----------------+----------------+----------------
Abkhazian                                     | abk            | ab             |                
Afar                                          | aar            | aa             |                
Afrikaans                                     | afr            | af             |                
...
pub(super) static LIST_LANGS_REMAINDER: &str = r#"'Are'are                                      | alu            |                |                
'Auhelawa                                     | kud            |                |                
A'ou                                          | aou            |                |                
A-Pucikwar                                    | apq            |                |                
Aari                                          | aiw            |                |                
