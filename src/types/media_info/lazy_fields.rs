...
macro_rules! lazy_fields_methods {
    (
        ...
        #[inline(always)]
        pub fn $try_init<F>(&mut self $(, $arg : $ty )* ) -> Result<()>
        where
            Self: $trait<F>,
        {
        ...
        /// Returns an error if the value could not be initialized.
        #[inline(always)]
        pub fn $try_mut<F>(&mut self $(, $arg : $ty )* ) -> Result<&mut <Self as $trait<F>>::FieldType>
        where
            Self: $trait<F>,
        {
        ...
        /// Returns an error if the value could not be initialized.
        #[inline(always)]
        pub fn $try_get<F>(&mut self $(, $arg : $ty )* ) -> Result<&<Self as $trait<F>>::FieldType>
        where
            Self: $trait<F>,
        {
        ...
        #[inline(always)]
        pub fn $try_immut<F>(&self $(, $arg : $ty )* ) -> Result<&<Self as $trait<F>>::FieldType>
        where
            Self: $trait<F>,
        {
        ...
        /// Returns an error if the field is uninitialized or an error occurred.
        #[inline(always)]
        pub fn $try_take<F>(&mut self $(, $arg : $ty )* ) -> Result<<Self as $trait<F>>::FieldType>
        where
            Self: $trait<F>,
        {
...
impl LazyPathNumField<MITICache> for MediaInfo<'_> {
    ...
    #[inline]
    fn try_init(&mut self, media: &Path, track: u64) -> Result<()> {
    ...
    #[inline]
    fn try_mut(&mut self, media: &Path, track: u64) -> Result<&mut Self::FieldType> {
    ...
    #[inline]
    fn try_immut(&self, media: &Path, track: u64) -> Result<&Self::FieldType> {
    ...
    #[inline]
    fn try_take(&mut self, media: &Path, track: u64) -> Result<Self::FieldType> {
...
lazy_path_fields!(
    ...
    saved_tracks, EnumMap<TrackType, Vec<u64>>, build_saved_tracks => MISavedTracks;
