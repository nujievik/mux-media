...
build_test_tracks_to_json_args!(
    test_audio_to_json_args, audio_tracks, "audio_tracks", "--audio", "--no-audio";
    test_subs_to_json_args, sub_tracks, "sub_tracks", "--subs", "--no-subs";
    test_video_to_json_args, video_tracks, "video_tracks", "--video", "--no-video";
);
