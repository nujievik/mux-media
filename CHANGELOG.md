...
### Added
- Localization for log prefixes.

### Changed
- Print ffmpeg logs on -vv arg.

### Fixed
- Write non-monotonic DTS files.
- Write PTS < DTS files.
...
### Fixed
- Save styles for retimed subtitles.
...
### Fixed
- Decrease priority attach stream (eg. cover.jpg) marked as 'Video' type in source.


## [0.16.6] - 2026-08-23

### Fixed
- Fix retiming base streams for prebuilt binaries.
...
### Changed
- Percentage progress: increase frequency & exclude repeats.
